          ...
          <div className='video-player'>
            ...
            <div className='current-playing-detail-container'>
             ...
             <div className='current-playing-detail-right-container'>
               ...
               {watchlaterVideos.find(item => item._id === videoId) ? <button className="btn flex detail-btn" onClick={() => removeFromWatchLater(token,setWatchlaterVideos,videoId,navigate)}><span className="material-icons icon">watch_later</span>Remove from Watch later</button>: <button className="btn flex detail-btn" onClick={() => addToWatchLater(currentVideoPlaying,token,setWatchlaterVideos,navigate)}><span className="material-icons-outlined icon">watch_later</span>Watch later</button>}
